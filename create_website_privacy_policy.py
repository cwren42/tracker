#!/usr/bin/env python3
"""
Create Public Website Privacy Notice from www.cirque.com
"""

import sqlite3
from datetime import datetime

def create_website_privacy_policy():
    """Create Website Privacy Notice"""
    db_path = '/var/www/tracker/assets.db'
    conn = sqlite3.connect(db_path)
    cursor = conn.cursor()
    
    print("📋 CREATING WEBSITE PRIVACY NOTICE")
    print("=" * 80)
    
    # Policy details
    document_id = "IS-CIRQ-P-041-G"
    ...
    # Define sections based on www.cirque.com/privacy-policy
    sections = [
        {
            "number": "1",
            "title": "Introduction",
            "content": """Effective date: January 01, 2019

Cirque Corporation ("us", "we", or "our") operates the www.cirque.com website (hereinafter referred to as the "Service").

This page informs you of our policies regarding the collection, use and disclosure of personal data when you use our Service and the choices you have associated with that data.

We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from www.cirque.com"""
        },
        {
            "number": "2",
            "title": "Definitions",
            "content": """Service: Service is the www.cirque.com website operated by Cirque Corporation
...
- Security Cookies: We use Security Cookies for security purposes."""
        },
        {
            "number": "4",
            "title": "Use of Data",
            "content": """Cirque Corporation uses the collected data for various purposes:
...
- To provide you with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless you have opted not to receive such information"""
        },
        {
            ...
            "content": """If you are from the European Economic Area (EEA), Cirque Corporation legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.

Cirque Corporation may process your Personal Data because:
...
- To comply with the law"""
        },
        {
            ...
            "content": """Cirque Corporation will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.

Cirque Corporation will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods."""
        },
        {
            "number": "7",
...
Cirque Corporation will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information."""
        },
        {
            "number": "8",
            "title": "Disclosure of Data",
            "content": """Business Transaction:
If Cirque Corporation is involved in a merger, acquisition or asset sale, your Personal Data may be transferred. We will provide notice before your Personal Data is transferred and becomes subject to a different Privacy Policy.

Disclosure for Law Enforcement:
Under certain circumstances, Cirque Corporation may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).

Legal Requirements:
Cirque Corporation may disclose your Personal Data in the good faith belief that such action is necessary to:
- To comply with a legal obligation
- To protect and defend the rights or property of Cirque Corporation
...
- To protect against legal liability"""
        ...
        {
            "number": "10",
            "title": "Do Not Track Signals (CalOPPA)",
            "content": """We do not support Do Not Track ("DNT"). Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked.
...
You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser."""
        },
        {
            ...
            "content": """If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Cirque Corporation aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.
...
- The right to withdraw consent: You also have the right to withdraw your consent at any time where Cirque Corporation relied on your consent to process your personal information.
